//Contantes
const URL_MESSAGE_GET_ALL = "http://127.0.0.1:8080/api/Message/all";
const URL_MESSAGE_GET_ID = "http://127.0.0.1:8080/api/Message";
const URL_MESSAGE_CREATE = "http://127.0.0.1:8080/api/Message/save";
const URL_MESSAGE_UPDATE = "http://127.0.0.1:8080/api/Message/update";
const URL_MESSAGE_DELETE = "http://127.0.0.1:8080/api/Message";
//Variables
