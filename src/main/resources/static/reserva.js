//Contantes
const URL_RESERVATION_GET_ALL = "http://127.0.0.1:8080/api/Reservation/all";
const URL_RESERVATION_GET_ID = "http://127.0.0.1:8080/api/Reservation";
const URL_RESERVATION_CREATE = "http://127.0.0.1:8080/api/Reservation/save";
const URL_RESERVATION_UPDATE = "http://127.0.0.1:8080/api/Reservation/update";
const URL_RESERVATION_DELETE = "http://127.0.0.1:8080/api/Reservation";
//Variables
